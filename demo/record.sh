...
OUT="${OUT:-demo/out}"
RAW="/tmp/chickadee-demo-raw.mov"
DISPLAY_ID="${DISPLAY_ID:-1}"
SETTLE="${SETTLE:-1.5}"    # seconds of quiet head and tail around each act

name_for() {
  case "$1" in
    1) echo "01-cli-basics" ;;   2) echo "02-wal-on-disk" ;;
    3) echo "03-durability" ;;   4) echo "04-corruption-recovery" ;;
    5) echo "05-concurrent-clients" ;;
  esac
}
